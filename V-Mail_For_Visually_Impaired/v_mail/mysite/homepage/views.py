...
attachment_dir = 'C:/Users/parth/Desktop/'
...
def login_view(request):
    ...
    if request.method == 'POST':
        text1 = "Welcome to our V-Mail. Login with your email account in order to continue."
        ...
        imap_url = 'imap.gmail.com'
        passwrd = 'xtxzaxelipqzkhie'
        #addr = 'tycsneha@gmail.com'
        #for the moment try email and random pass #which pass this time?
        

        conn = imaplib.IMAP4_SSL(imap_url)
        try:
            '''if passwrd == 'project.6':
                passwrd = 'xtxzaxelipqzkhie' '''
